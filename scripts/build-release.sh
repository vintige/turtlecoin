...
function usage()
{
    ...
    echo "and generates the checksum files of the Xaria tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/xaria-coin/xaria.git"
CLONE_DIR="$BUILD_DIRECTORY/xaria-buildall"
TARGET_DIR="$BUILD_DIRECTORY/xaria-releases"
DYNAMIC_RELEASE="xaria-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="xaria-${TAG_VERSION}-linux-staticboost-CLI"
